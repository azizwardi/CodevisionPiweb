                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-800 font-medium">
                      {user.facebook ? (
                        <a href={user.facebook} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                          {user.facebook}
                        </a>
                      ) : (
                        'Not provided'
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 font-medium">
                      {user.twitter ? (
                        <a href={user.twitter} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                          {user.twitter}
                        </a>
                      ) : (
                        'Not provided'
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 font-medium">
                      {user.linkedin ? (
                        <a href={user.linkedin} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                          {user.linkedin}
                        </a>
                      ) : (
                        'Not provided'
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 font-medium">
                      {user.instagram ? (
                        <a href={user.instagram} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                          {user.instagram}
                        </a>
                      ) : (
                        'Not provided'
