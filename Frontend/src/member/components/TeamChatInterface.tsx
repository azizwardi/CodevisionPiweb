...
const TeamChatInterface: React.FC<TeamChatInterfaceProps> = ({ teamId, userId, team }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      newSocket.on('newTeamMessage', (message: any) => {
        console.log('New team message received from another user:', message);
      ...
      newSocket.on('yourMessageSent', (message: any) => {
        console.log('Your message was sent and saved:', message);
        ...
        setMessages(prevMessages => {
          ...
          console.log('Adding our message to the UI');
      ...
      newSocket.on('messagesRead', (data: any) => {
        console.log('Member - Messages read event received:', data);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      console.log('Created temporary message with ID:', tempMessage._id);
