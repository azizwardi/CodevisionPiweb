...
const MemberLayout: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      {/* Shared Navbar */}
      <SharedNavbar title="Member Portal" bgColor="bg-green-600" />

      {/* Main Content */}
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside className="w-64 bg-gray-700 text-white hidden md:block">
          <nav className="p-4">
      ...
      <footer className="bg-gray-700 text-white py-4">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; {new Date().getFullYear()} Member Portal. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
