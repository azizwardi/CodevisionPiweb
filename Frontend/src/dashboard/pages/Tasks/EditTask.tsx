...
const EditTask: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          toastManager.addToast("Erreur lors du chargement de la tâche", "error", 5000);
          navigate("/tasks");
          return;
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Sending task update to API:", formData);
      ...
      const response = await axios.put(`http://localhost:5000/tasks/${taskId}`, taskData);
  ...
  return (
    <div>
      <PageMeta
        title="Edit Task | CodevisionPiweb"
        description="Edit task for CodevisionPiweb"
      />
