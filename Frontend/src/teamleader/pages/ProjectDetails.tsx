    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <Button
            variant="outline"
            onClick={() => navigate(`/team-leader/projects/${projectId}/kanban`)}
          >
            Vue Kanban
          </Button>
          <Button
            variant="primary"
            onClick={() => navigate(`/team-leader/tasks/create?projectId=${projectId}`)}
          >
            Ajouter une tâche
          </Button>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p><span className="font-medium">Date de fin:</span> {formatDate(project.deadline)}</p>
                  </div>
                </div>
                <div>
                      ...
                      <tr key={task._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <Button
                            ...
                            variant="outline"
                            className="mr-2"
                            onClick={() => navigate(`/team-leader/tasks/edit/${task._id}`)}
                          >
                            Modifier
                          </Button>
                        </td>
